export default({
   state: {
      ...
      goods: localStorage.getItem('goods')?JSON.parse(localStorage.getItem('goods')):[
         ...
         {id: 10, marka: "", new: false, delivery: "", typeId: 33, views: 888, fav: false, city: "Bakı", shop: true, title: "Həyət evi kirayə verilir, Quba r.", price: 70, date: "2018-05-02 17:35", src: "", status: "vip"},
         {id: 11, marka: "", new: false, delivery: true, typeId: 41, views: 5437, fav: false, city: "Bakı", shop: true, title: "Qızıl üzüklər", price: 170, date: "2020-11-10 18:45", src: "", status: "ad"},
